# CycPepFlow v0.1.0 — private checkpoint release
...
The training entry point (`train.py`) is intentionally not distributed. CycPepFlow modifications are licensed under Apache-2.0; adapted ET-Flow source retains its MIT notice.
