...
class MoleculeFeaturizer:
    ...
    def __init__(self, include_chirality_in_node_attr: bool = True):
        # Whether the atom node_attr contains RDKit atom chiral-tag information.
        # Chiral-center tensors are computed separately and are not affected.
    ...
    def get_atom_features_from_mol(
        self,
        mol: Mol,
        use_ogb_feat: bool = True,
        include_chirality_in_node_attr: bool | None = None,
    ) -> torch.Tensor:
        if include_chirality_in_node_attr is None:
            ...
            atom_features = torch.tensor(
                [
                    atom_to_feature_vector(
                        atom,
                        include_chirality=include_chirality_in_node_attr,
                    )
